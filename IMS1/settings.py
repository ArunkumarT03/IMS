"""
Django settings for IMS1 project.
...
#         'HOST': os.getenv('DB_HOST'),       # or server IP
...
def check_mysql_connection(request):
    try:
        ...
        return JsonResponse({"status": 1, "message": "MySQL connected successfully"})
    except Exception as e:
        return JsonResponse({"status": 0, "message": "MySQL connection failed", "error": str(e)})
...
WSGI_APPLICATION = 'IMS1.wsgi.application'
